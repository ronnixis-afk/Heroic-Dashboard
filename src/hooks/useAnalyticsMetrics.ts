...
function formatAnalyticsOverview(overview: AnalyticsOverviewResponse) {
...
async function fetchAnalyticsMetrics(
  ...
  try {
    const overview = await fetchRpgAdmin<AnalyticsOverviewResponse>(
    ...
    console.warn(
      '[AnalyticsAudit] Consolidated overview fetch failed, falling back to parallel fetches:',
      error
    );
  }
