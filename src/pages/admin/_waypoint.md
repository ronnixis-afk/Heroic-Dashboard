...
| `/admin/news` | Global News & Patch Notes | Dynamic App Version manager (`app_version`), Announcements CMS, Public Patch Notes publisher, and real-time App Update Popup overlay manager with feature highlight builder and 1-click Push/Activate. |
