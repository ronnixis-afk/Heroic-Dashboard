    ...
    <div className="min-h-screen bg-[#0A0A0A] text-brand-text overflow-x-hidden">
      ...
      <nav className="relative flex items-center justify-between px-6 py-6 max-w-7xl mx-auto z-50">
        <div className="flex items-center gap-3">
          <div className="h-10 w-10 rounded-xl bg-brand-accent flex items-center justify-center shadow-lg shadow-brand-accent/20">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-bold text-[#8b8c94]">
          <a href="#" className="hover:text-brand-accent transition-colors">Lore</a>
          <a href="#" className="hover:text-brand-accent transition-colors">Mechanics</a>
        ...
        >
          {isMenuOpen ? <Zap size={24} className="text-brand-accent" /> : <Zap size={24} />}
        </button>
      ...
      <section className="relative px-6 pt-12 md:pt-20 pb-24 md:pb-32 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="inline-flex items-center gap-2 rounded-full border border-[#20cce0]/20 bg-[#20cce0]/5 px-4 py-1.5 text-[10px] font-bold text-[#20cce0] mb-8"
          >
            <Sparkles size={14} />
          ...
          >
            ...
            <span className="text-[#20cce0]">Infinite Worlds.</span>
          </motion.h1>
      ...
      <section className="px-6 py-16 md:py-20 bg-brand-surface/30">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-10 md:mb-12 gap-4">
            ...
            <button className="text-sm font-bold text-[#20cce0] flex items-center gap-2 hover:underline w-fit">
            ...
            {news.map((item, idx) => (
              ...
              >
                ...
                <div className="p-6 flex-1 flex flex-col">
                  <span className="text-[10px] font-bold text-[#20cce0] mb-2">Announcement</span>
                  ...
                  <div className="mt-auto pt-4 border-t border-[#292a32]/50 flex items-center justify-between text-xs text-[#8b8c94]">
                    ...
                    <button className="font-bold text-white hover:text-[#20cce0] transition-colors">Read More</button>
                  </div>
                </div>
              </motion.article>
            ))}
      ...
      <section className="px-6 py-24 md:py-32 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="glass-panel md:col-span-2 p-6 md:p-8 flex flex-col justify-end min-h-[250px] md:min-h-[300px] relative overflow-hidden group">
            <Sword className="absolute -top-4 -right-4 size-24 md:size-32 text-[#20cce0]/10 rotate-12 group-hover:scale-110 transition-transform" />
          ...
          <div className="glass-panel p-6 md:p-8 flex flex-col justify-end min-h-[200px] md:min-h-[300px]">
            <Zap className="text-[#20cce0] mb-4" size={32} />
          ...
          <div className="glass-panel p-6 md:p-8 flex flex-col justify-end min-h-[200px] md:min-h-[300px]">
             <Users className="text-[#20cce0] mb-4" size={32} />
      ...
      <footer className="border-t border-[#292a32]/30 py-12 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8 text-center md:text-left">
          <div className="flex items-center gap-3">
            <Shield size={20} className="text-[#20cce0]" />
          ...
          <div className="flex gap-6 text-xs font-bold text-[#8b8c94]">
            <a href="#" className="hover:text-[#20cce0] transition-colors">Privacy</a>
            <a href="#" className="hover:text-[#20cce0] transition-colors">Terms</a>
            <a href="#" className="hover:text-[#20cce0] transition-colors">Discord</a>
          </div>
        </div>
      </footer>
    </div>
